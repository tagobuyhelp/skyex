...
export const DashboardHeader = ({
  ...
  return <div className="mb-6 md:mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 backdrop-blur-lg bg-black p-4 md:p-6 rounded-lg border border-white/10 text-white">
      <div>
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 md:gap-4 w-full md:w-auto">
        <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
          <NoticeManageModal trigger={<Button variant="outline" className="w-full sm:w-auto bg-black hover:bg-white/10 border-white/10 text-white">
