      ...
      <div className="bg-[#261F06]/80 backdrop-blur-md rounded-lg p-4 md:p-8 border border-primary/20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
          <div className="bg-[#1A1704] rounded-lg p-4 md:p-6 border border-primary/10">
            <h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4 text-primary text-center">
              অনলাইন সুপার এজেন্ট
            </h3>
            <div className="bg-[#2A2410] rounded p-3 md:p-4">
              <p className="text-muted-foreground text-base md:text-lg leading-relaxed">সুপার এজেন্টরা ইউজার একাউন্ট এবং মা্টার এজেন্ট একাউন্ট খুলেতে পারেন। কোন সুপার এজেন্টের নামে অভিযোগ থাকলে সরাসরি এডমিনকে জানাতে হবে উপরে মেনুতে এডমিন লিস্ট দেওয়া আছে।</p>
            </div>
          </div>
          <div className="bg-[#1A1704] rounded-lg p-4 md:p-6 border border-primary/10">
            <h3 className="text-lg md:text-xl font-semibold mb-3 md:mb-4 text-primary text-center">
