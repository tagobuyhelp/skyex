...
export const OfficialLinksSection = () => {
  ...
  return (
    <section className="container py-6 md:py-12 px-4">
      <div className="glass-card p-4 md:p-6 bg-white/90 shadow-md">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
          <a href="http://skyex247.pro" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-3 md:p-4 bg-blue-50 rounded-lg hover:bg-primary/10 transition-colors">
