    ...
    <section className="container py-6 md:py-12 px-4">
      <div className="glass-card p-4 md:p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 md:gap-4">
          <a href="http://easy24.site" target="_blank" rel="noopener noreferrer" className="flex items-center justify-between p-3 md:p-4 bg-secondary/50 rounded-lg hover:bg-primary/20 transition-colors">
