    ...
    <div key={agent.id} className="glass-card p-4">
      ...
      <div className="space-y-2 text-base">
        <div className="flex justify-between items-center">
          ...
          <span className="px-2 py-0.5 bg-emerald-500/20 rounded text-emerald-400 font-medium text-sm">
            {agent.agent_id}
          </span>
        </div>
          ...
          {isAuthenticated && (
            <>
              <AgentManageModal
                ...
                agent={agent}
                trigger={
                  <button className="p-2 hover:bg-blue-500/20 rounded-lg transition-colors flex items-center gap-1.5">
