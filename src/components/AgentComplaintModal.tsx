  ...
  return <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      `}>
        ...
        <div className="space-y-5">
          ...
          {/* Upline Agent Info */}
          {uplineAgent && <div className="space-y-3">
          ...
          <div className="space-y-3">
            <div>
              ...
              <input id="whatsapp" type="text" className="w-full bg-gray-800 border border-gray-700 rounded-lg p-2.5 text-xs sm:text-sm text-white placeholder-gray-500" placeholder="কান্ট্রি কোড সহ লিখুন (যেমন: +8801234567890)" />
            </div>
            ...
            <div>
              ...
              <textarea id="complaint" rows={4} className="w-full bg-gray-800 border border-gray-700 rounded-lg p-2.5 text-xs sm:text-sm text-white placeholder-gray-500 resize-none" placeholder="রিপোর্টের কারণ বিস্তারিত লিখুন..." />
            </div>
          </div>

          {/* Action Buttons */}
          <div className="flex justify-end gap-2 pt-2">
            <button onClick={() => onOpenChange(false)} className="px-3 py-1.5 rounded-lg bg-gray-800 text-xs sm:text-sm text-gray-300 hover:bg-gray-700 transition-colors">
              বাতিল করুন
            </button>
            <button className="px-3 py-1.5 rounded-lg bg-red-500 text-xs sm:text-sm text-white hover:bg-red-600 transition-colors">
              রিপোর্ট করুন
            </button>
          </div>
        </div>
